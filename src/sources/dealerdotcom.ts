...
/** A third scan pass; the hit rate on guessed domains falls off sharply here. */
export const mileone = dealerDotCom({ id: 'mileone', host: 'https://www.mileone.com' });
export const hertrichs = dealerDotCom({ id: 'hertrichs', host: 'https://www.hertrichs.com' });
export const mcgeecars = dealerDotCom({ id: 'mcgeecars', host: 'https://www.mcgeecars.com' });
