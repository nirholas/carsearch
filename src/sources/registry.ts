...
export const SOURCES: Source[] = [
  ...
  s({ id: 'cargurus', name: 'CarGurus', homepage: 'https://www.cargurus.com', category: 'marketplace',
      transport: 'browser', access: 'jsonld',
      notes: 'Re-verified 2026-09-07: fetch 406, browser 200 with 33 prices and a JSON-LD block. Reachable, adapter not written yet.' }),
  s({ id: 'autotrader', name: 'Autotrader', homepage: 'https://www.autotrader.com', category: 'marketplace',
      status: 'blocked', transport: 'blocked',
      notes: 'Tested: 403 to both a plain fetch and a fully fingerprinted real browser. Reachable only by buying data. Do not burn time here.' }),
  ...
  s({ id: 'carvana', name: 'Carvana', homepage: 'https://www.carvana.com', category: 'retailer',
      status: 'via-aggregator', transport: 'blocked', reachableVia: { sourceId: 'autotempest', code: 'cv' },
      notes: 'Tested: Cloudflare refuses both transports. Reached only through AutoTempest.' }),
  ...
  s({ id: 'autonation', name: 'AutoNation', homepage: 'https://www.autonation.com', category: 'dealer-group',
      status: 'blocked', transport: 'blocked', notes: 'Tested: 403 both transports.' }),
  ...
  s({ id: 'craigslist', name: 'Craigslist', homepage: 'https://www.craigslist.org', category: 'classified',
      transport: 'fetch', notes: 'Per-city subdomains, RSS on search results, no API, heavily IP-sensitive. Plan for residential proxies.' }),
  ...
  s({ id: 'pcarmarket', name: 'PCARMARKET', homepage: 'https://www.pcarmarket.com', category: 'auction-enthusiast',
      priceKinds: ['sold', 'bid'], notes: 'Tested: 200 to Chromium. Porsche-heavy.' }),
  s({ id: 'hemmings', name: 'Hemmings', homepage: 'https://www.hemmings.com', category: 'auction-enthusiast',
      status: 'blocked', transport: 'blocked', priceKinds: ['ask', 'bid'], notes: 'Tested: 403 both transports.' }),
  ...
  s({ id: 'collectingcars', name: 'Collecting Cars', homepage: 'https://collectingcars.com', category: 'auction-enthusiast',
      countries: ['GB', 'US', 'AU'], priceKinds: ['sold', 'bid'] }),
  s({ id: 'hagertymarketplace', name: 'Hagerty Marketplace', homepage: 'https://marketplace.hagerty.com', category: 'auction-enthusiast', priceKinds: ['sold', 'bid'] }),
  ...
  s({ id: 'copart', name: 'Copart', homepage: 'https://www.copart.com', category: 'auction-salvage',
      countries: ['US', 'CA', 'GB', 'DE'], status: 'blocked', transport: 'blocked', priceKinds: ['bid', 'sold'],
      notes: 'Tested 2026-09-07: a plain fetch returns a JavaScript shell with no listings and the browser renders zero text at all. The search results come from an internal JSON endpoint that has to be found and called directly. Worth doing, since Copart is one of the few free sources of per-VIN transaction history, but it is not a page-scrape.' }),
  ...
  s({ id: 'autoscout24', name: 'AutoScout24', homepage: 'https://www.autoscout24.com', category: 'marketplace',
      countries: ['DE', 'AT', 'CH', 'IT', 'NL', 'BE', 'ES', 'FR'], access: 'api',
      notes: 'Has an actual REST API. One adapter covers a dozen country domains.' }),
  ...
  s({ id: 'blocket', name: 'Blocket', homepage: 'https://www.blocket.se', category: 'classified', countries: ['SE'] }),
  s({ id: 'finnno', name: 'Finn.no', homepage: 'https://www.finn.no/mobility', category: 'marketplace', countries: ['NO'] }),
