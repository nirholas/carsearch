...
export const SOURCES: Source[] = [
  ...
  s({ id: 'carandclassic', name: 'Car & Classic', homepage: 'https://www.carandclassic.com', status: 'live', transport: 'tls', access: 'jsonld', category: 'auction-enthusiast', countries: ['GB'], priceKinds: ['ask', 'sold'],
    notes: 'Wired 2026-09-10. Publishes bare Vehicle nodes with no ItemList around them, which is why it read as empty until the reader learned to take standalone nodes: 59 nodes, 57 priced. Mileage is tagged SMI or KMT per listing.',
  }),
