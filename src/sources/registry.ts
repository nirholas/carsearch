...
export const SOURCES: Source[] = [
  ...
  s({ id: 'autotraderca', name: 'AutoTrader.ca', homepage: 'https://www.autotrader.ca', status: 'live', transport: 'tls', access: 'jsonld', category: 'marketplace', countries: ['CA'],
    notes: 'Wired 2026-09-10. Its search pages publish a schema.org ItemList of Car/Product nodes; 20 read on the first page with kilometre odometers, which the shared adapter converts. Canada is the largest non-US English-language pool.',
  }),
  ...
  s({ id: 'pakwheels', name: 'PakWheels', homepage: 'https://www.pakwheels.com', category: 'marketplace', countries: ['PK'],
    notes: 'Probed 2026-09-10: 43 ItemList entries with a title and city but never an amount, e.g. \'Porsche Taycan 2020 for sale in Lahore\'. Reachable and structured, just not priced on the search page.',
  }),
