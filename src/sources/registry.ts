...
export const SOURCES: Source[] = [
  ...
  s({ id: 'koons', name: 'Koons Automotive', homepage: 'https://www.koons.com', category: 'dealer-group', countries: ['US'],
    status: 'live', transport: 'fetch', access: 'feed',
    notes: 'Wired 2026-09-12 on the same Cars Commerce platform as Ken Garff, which is the point of wiring a platform rather than a site: the next Dealer Inspire group costs a host and a registry row. Virginia and Maryland rooftops.' }),
